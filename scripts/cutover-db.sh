...
echo ""
echo "アプリはまだ停止中（ダウンタイム継続中）。次の手順で切替を完了してください:"
echo "  1. cd infrastruture/terraform/prod/db/rdb && terragrunt apply"
echo "  2. cd ../secret && terragrunt apply"
echo "  3. prodにSSHして: sudo systemctl start ${APP_NAME}-backend"
